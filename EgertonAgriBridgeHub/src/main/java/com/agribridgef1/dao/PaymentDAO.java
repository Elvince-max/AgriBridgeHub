...
public class PaymentDAO {
    ...
    public boolean savePayment(int orderId, double amount, String method, String code, String status) {
        String sql =
                "INSERT INTO payments (order_id, amount, payment_method, transaction_code, payment_status) " +
                "VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean updateMpesaPaymentStatus(String checkoutRequestId, String transactionCode, String paymentStatus) {
        ...
        try {
            ...
            /*
                If it was already PAID and another callback arrives,
                do not reduce stock again.
            */
            boolean alreadyPaid = "PAID".equalsIgnoreCase(oldStatus);
            ...
            if ("PAID".equalsIgnoreCase(paymentStatus) && !alreadyPaid) {
